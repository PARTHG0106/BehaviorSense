...
|---|---|---|---|---|---|---|---|---|---|---|---|
| grammar-constrained | `z-ai/glm-5.2:free via nvidia/nemotron-3-super-120b-a12b:free (openrouter, 20 key(s))` | 116 | 692 | 692 | 0 | 692 | **0.0%** | 0.0%-0.6% | **0.0%** | 0 | 0 |
| unconstrained | `z-ai/glm-5.2:free via nvidia/nemotron-3-super-120b-a12b:free (openrouter, 20 key(s), schema not enforced)` | 116 | 694 | 694 | 0 | 694 | **0.0%** | 0.0%-0.6% | **0.0%** | 0 | 0 |
| unconstrained + format repair | `z-ai/glm-5.2:free via nvidia/nemotron-3-super-120b-a12b:free (openrouter, 20 key(s), schema not enforced)` | 116 | 694 | 694 | 0 | 694 | **0.0%** | 0.0%-0.6% | **0.0%** | 0 | 0 |
